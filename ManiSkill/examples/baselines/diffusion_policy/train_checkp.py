...
import Domain_rand_pick
import Stack_cube_new
import Domain_rand_stack
...
# -----------------------------------------------------------------------------
# Modified Dataset: Data is kept on CPU; GPU transfer is delayed.
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# Helper function to move mini-batches to GPU (called in the main loop)
# -----------------------------------------------------------------------------
...
if __name__ == "__main__":
    ...
    train_dataloader = DataLoader(
        ...
        pin_memory=True,
        # Use default collate_fn so that no GPU transfers happen in worker processes.
