...
@register_env("PickCube-v1-DR", max_episode_steps=100)
class PickCubeEnv(BaseEnv):
    ...
    **Success Conditions:**
    ...
    def _load_scene(self, options: dict):
        ...
        self.cube_half_size = np.random.uniform(0.02, 0.03)
    ...
    def _load_lighting(self, options: dict):
        ...
        self.scene.set_ambient_light([np.random.uniform(0.2, 0.7), np.random.uniform(0.2, 0.7), np.random.uniform(0.2, 0.7)])
